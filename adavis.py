...
#
#
#   Copyright 2012 Magnus aPersson <magnusp@nbi.dk>
#
...
#regions (just like the region keyword) <- perhaps share code is a good
#idea here(?)
...
DONE :  Add ALMA in get_telescope_diameter function
